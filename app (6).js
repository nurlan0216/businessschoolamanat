...
// ========= УНИВЕРСАЛЬНЫЕ БЛОКИРАТОРЫ ЗОН YOUTUBE =========function installYtBlockers(slot) {
  ...
  // ── Низ (без правого угла): share/часы/YouTube-лого — 88% ширины ──
  const botW = Math.round(vw * 0.88);
  const botH = Math.round(vh * 0.18);
